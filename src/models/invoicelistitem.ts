...
import {
  ...
  InvoiceListSubscrptionDto$inboundSchema,
} from "./invoicelistsubscrptiondto.js";
import {
  InvoiceStatusEnum,
...
export type InvoiceListItem = {
  ...
  subscription?: InvoiceListSubscrptionDto | null | undefined;
  payments?: Array<PaymentDto> | null | undefined;
  /**
   * Total number of payments for this invoice
   */
  totalNumberOfPayments: number;
  /**
   * The date when the last payment was paid
   */
  lastPaymentPaidAt?: Date | null | undefined;
};
...
> = z.pipe(
  z.object({
    ...
    remaining_amount: z.optional(z.nullable(types.string())),
    paid_amount: types.string(),
    organization_consumer:
      AppCommonDtosSharedOrganizationConsumer$inboundSchema,
    subscription: z.optional(
      z.nullable(InvoiceListSubscrptionDto$inboundSchema),
    ),
    payments: z.optional(z.nullable(z.array(PaymentDto$inboundSchema))),
    total_number_of_payments: types.number(),
    last_payment_paid_at: z.optional(z.nullable(types.date())),
  }),
  z.transform((v) => {
    return remap$(v, {
