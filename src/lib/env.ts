...
export interface Env {
  STREAMSDK_JWT_BEARER?: string | undefined;

  STREAMSDK_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodMiniType<Env, unknown> = z.object({
  STREAMSDK_JWT_BEARER: z.optional(z.string()),

  STREAMSDK_DEBUG: z.optional(z.coerce.boolean()),
});
